...
static TranslationEntry translations [] = {
        ...
        { MOUSE_SCHEMA,     "cursor-theme",           "Ctk/CursorThemeName",           translate_string_string },
        { MOUSE_SCHEMA,     "cursor-size",            "Ctk/CursorThemeSize",           translate_int_int },

        { INTERFACE_SCHEMA, "font-name",              "Ctk/FontName",                  translate_string_string },
        { INTERFACE_SCHEMA, "ctk-key-theme",          "Ctk/KeyThemeName",              translate_string_string },
        { INTERFACE_SCHEMA, "toolbar-style",          "Ctk/ToolbarStyle",              translate_string_string_toolbar },
        { INTERFACE_SCHEMA, "toolbar-icons-size",     "Ctk/ToolbarIconSize",           translate_string_string },
        ...
        { INTERFACE_SCHEMA, "ctk-color-scheme",       "Ctk/ColorScheme",               translate_string_string },
        { INTERFACE_SCHEMA, "ctk-im-preedit-style",   "Ctk/IMPreeditStyle",            translate_string_string },
        { INTERFACE_SCHEMA, "ctk-im-status-style",    "Ctk/IMStatusStyle",             translate_string_string },
        { INTERFACE_SCHEMA, "ctk-im-module",          "Ctk/IMModule",                  translate_string_string },
        { INTERFACE_SCHEMA, "icon-theme",             "Net/IconThemeName",             translate_string_string },
        { INTERFACE_SCHEMA, "file-chooser-backend",   "Ctk/FileChooserBackend",        translate_string_string },
        { INTERFACE_SCHEMA, "ctk-decoration-layout",  "Ctk/DecorationLayout",          translate_string_string },
        { INTERFACE_SCHEMA, "ctk-shell-shows-app-menu","Ctk/ShellShowsAppMenu",        translate_bool_int },
        { INTERFACE_SCHEMA, "ctk-shell-shows-menubar","Ctk/ShellShowsMenubar",         translate_bool_int },
        { INTERFACE_SCHEMA, "menus-have-icons",       "Ctk/MenuImages",                translate_bool_int },
        { INTERFACE_SCHEMA, "buttons-have-icons",     "Ctk/ButtonImages",              translate_bool_int },
        { INTERFACE_SCHEMA, "menubar-accel",          "Ctk/MenuBarAccel",              translate_string_string },
        { INTERFACE_SCHEMA, "show-input-method-menu", "Ctk/ShowInputMethodMenu",       translate_bool_int },
        { INTERFACE_SCHEMA, "show-unicode-menu",      "Ctk/ShowUnicodeMenu",           translate_bool_int },
        { INTERFACE_SCHEMA, "automatic-mnemonics",    "Ctk/AutoMnemonics",             translate_bool_int },
        {INTERFACE_SCHEMA, "ctk-enable-primary-paste", "Ctk/EnablePrimaryPaste",
translate_bool_int },
        { INTERFACE_SCHEMA, "ctk-enable-animations",  "Ctk/EnableAnimations",          translate_bool_int },
        { INTERFACE_SCHEMA, "ctk-dialogs-use-header", "Ctk/DialogsUseHeader",          translate_bool_int },
                            ...
                            CafeXftSettings      *settings)
{
        ...
        for (i = 0; manager->priv->managers [i]; i++) {
                ...
                xsettings_manager_set_int (manager->priv->managers [i], "Ctk/CursorThemeSize", settings->cursor_size);
                xsettings_manager_set_string (manager->priv->managers [i], "Ctk/CursorThemeName", settings->cursor_theme);
        }
